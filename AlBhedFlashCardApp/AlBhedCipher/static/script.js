...
class AlBhedQuiz {
    constructor() {
        ...
        this.currentIndex = 0;
        this.score = 0;
        this.isAlBhedToEnglish = false; // false = English->AlBhed, true = AlBhed->English
    ...
    initializeEventListeners() {
        ...
        // Quiz mode toggle
        document.getElementById('quiz-mode-toggle').addEventListener('change', (e) => {
            this.isAlBhedToEnglish = e.target.checked;
    ...
    updateModeDescription() {
        ...
        if (this.isAlBhedToEnglish) {
            description.innerHTML = `
                <i class="fas fa-info-circle me-1"></i>
                You'll see Al Bhed letters and type English equivalents
            `;
        } else {
            description.innerHTML = `
                <i class="fas fa-info-circle me-1"></i>
    ...
    async startQuiz() {
        try {
            const response = await fetch('/start_quiz', {
                ...
                body: JSON.stringify({ 
                    mode: this.isAlBhedToEnglish ? 'albhed_to_english' : 'english_to_albhed'
                })
            });
    ...
    updateCurrentQuestion() {
        ...
        // Update question title and display based on mode
        const questionTitle = document.getElementById('question-title');
        if (this.isAlBhedToEnglish) {
            questionTitle.textContent = 'What is the English equivalent of:';
        } else {
            questionTitle.textContent = 'What is the Al Bhed equivalent of:';
        }
